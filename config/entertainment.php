...
<body>
            ...
            <div class="index_div_create">
                <div class="index_category">
                    ...
                    <ul>
                        ...
                        <li class="index_cat_list"><a href="entertainment.php?entertainment=1" id="all" >Entertainment</a></li>
    ...
    ON posts_message.user_id = user_account.user_id where  post_category = 'Entertainment'  ORDER BY post_id DESC  LIMIT 21";
    ...
    <div style="border:1px solid #000; margin-top: 290px; " > <?php else: echo" No post result found "; ?></div>
