...
<body>
    ...
    <div class="admin_container_div" style="margin: 0 auto;">
        <div class="admin_sidebar_div" style="background-color: #f4f4f4;">
        ...
        <form method="post" action="admin.php" enctype="multipart/form-data" class="admin_form"  style="background-color: #f4f4f4;">
