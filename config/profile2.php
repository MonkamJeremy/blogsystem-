    ...
    <div class="profile_div_container">
        <div class="profile_div_sidebar">
            ...
            if (isset($_GET['user_id'])) {
                ...
                // Fetch user details
                $result = $conn->query("SELECT * FROM user_account WHERE user_id = $user_id");
                if ($result->num_rows > 0) {
                    $user = $result->fetch_assoc();
                    echo '<img src="uploaded_images/'.$user['user_profilephoto']. '" alt="profile picture" style="margin: auto;" class="profile_userprofile_photo">';;
                } else {
                    echo "User not found.";
                }
            }
            ...
            <ul class="profile_userdetails">
                ...
                <input type="text" name="username" class="input"   id="username" value="<?php echo $user['user_name'];?>"><br><br>
                <input type="file"  name="image" class="input"  id="profile_img"  ><br><br>
                
                <input type="text" name="useremail" class="input" id="useremail" value=" <?php echo $user['user_email'];?>"><br> <br> 
