...
<body>
  <div class="index_con">
    ...
    <div class="index_div_create">
       <div class="index_category">
            ...
            <ul>
                ...
                <li class="index_cat_list"><a href="tech.php?tech=1" id="all" >Technology</a></li>
    ...
    ON posts_message.user_id = user_account.user_id where  post_category = 'Technology'  ORDER BY post_id DESC LIMIT 21";
