...
<body>
            ...
            <div class="index_div_create">
                <div class="index_category">
                    ...
                    <ul>
                        ...
                        <li class="index_cat_list"><a href="health.php?health=1" id="all" >Health</a></li>
    ...
    ON posts_message.user_id = user_account.user_id where  post_category = 'Health'  ORDER BY post_id DESC  LIMIT 21";
